...
const slidesData = [
    { imgSrc: "./public/1.png", itemName: "Light Green hand Printed Banarsee Zari", originalPrice: "₹ 1,200", salePrice: "₹ 900" },
    { imgSrc: "./public/2.png", itemName: "Light Green hand Printed Banarsee Zari", originalPrice: "₹ 1,200", salePrice: "₹ 900" },
    { imgSrc: "./public/3.png", itemName: "Light Green hand Printed Banarsee Zari", originalPrice: "₹ 1,200", salePrice: "₹ 900" },
    { imgSrc: "./public/4.png", itemName: "Light Green hand Printed Banarsee Zari", originalPrice: "₹ 1,200", salePrice: "₹ 900" },
    { imgSrc: "./public/5.png", itemName: "Light Green hand Printed Banarsee Zari", originalPrice: "₹ 1,200", salePrice: "₹ 900" }
    // Add more as needed
];
const slidesData2 = [
    { imgSrc: "./public/1.png", itemName: "Light Green hand Printed Banarsee Zari", originalPrice: "₹ 1,200", salePrice: "₹ 900" },
...
const swiperWrapper = document.querySelector('.swiper-wrapper.craft-swiper-wrapper');
...
function populateSwiper0() {
    const swiperWrapper0 = document.querySelector('.swiper-wrapper.craft-swiper-wrapper'); // Adjust selector as needed
